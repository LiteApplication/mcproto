...
@final
@define
class GameProfile(ClientBoundPacket):
    """Sent by the server to denote a successful login. (Server -> Client).

    Initialize the GameProfile packet.
...
@final
@define
class CustomQueryAnswer(ServerBoundPacket):
    """Response to CustomQuery from client. (Client -> Server).

    Initialize the CustomQuery packet.
